...
import Route from '@ember/routing/route';
import { PaginationControllerClass } from './controller-pagination';

export type ConcreteSubclass<T> = new (...args: any[]) => T;
export type PaginationRoute = ConcreteSubclass<Route>;
export function RoutePagination<T extends PaginationRoute>(RouteSubclass: T) {
    class PaginationClass extends RouteSubclass {
        /**
         ...
         */
        getControllerParams(routeName: string = this.routeName): any {
    ...
    return PaginationClass as PaginationRoute;
}
